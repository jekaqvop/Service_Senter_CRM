...
using ServerServiceCenter.DAL.Pattern.Repositories;

namespace DAL.Pattern
{
    public class UnitOfWork : IDisposable
    {
        ...
        private HistoryChangeOrdesrRep historyChangeOrdesrRep;

        public HistoryChangeOrdesrRep GetHistoryChangeOrdesrRep()
        {
            if (historyChangeOrdesrRep == null)
                historyChangeOrdesrRep = new HistoryChangeOrdesrRep(context);
            return historyChangeOrdesrRep;
        }
        
        //public ReviewsRepository GetReviewRepository()
        //{
        //    if (reviewRepository == null)
        //        reviewRepository = new ReviewsRepository(context);
